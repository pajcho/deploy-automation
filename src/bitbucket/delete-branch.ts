...
import { BranchData } from '../models/bitbucket.model';
 ...
 */
export async function deleteBranch(branchData: Omit<BranchData, 'source'>, credentials: DeployConnection): Promise<Omit<BranchData, 'source'> | false> {
