...
import { ExistingPullRequestData, MergePullRequestResponse } from '../models/bitbucket.model';
 ...
 */
export async function mergePullRequest(pullRequestData: ExistingPullRequestData, credentials: DeployConnection): Promise<MergePullRequestResponse | false> {
